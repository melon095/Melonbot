...
import { UserContext, WebWorkerMonacoContext } from '../../../App';
...
export default function () {
	...
	const worker = React.useMemo(
		() => new Worker('/wasm/monaco_lsp/worker.js', { type: 'module' }),
		[],
	);
	...
	return (
		<WebWorkerMonacoContext.Provider value={worker}>
			<div className="mx-20">
								...
								<li className="mr-2">
									<a
										...
										title={`${
											has_channel
												? ''
												: 'Melonbot is not joined in your channel.'
										}`}
									>
										<span>Channel</span>
									</a>
		...
		</WebWorkerMonacoContext.Provider>
	);
}
